...
protagonista = sprites.create(img`
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
protagonista.setPosition(20, 60)
...
let fantasma = sprites.create(img`
    ...
    ........................
    `, SpriteKind.Enemy)
fantasma.setPosition(120, 60)
let velocidad = 20
fantasma.follow(protagonista, velocidad)
protagonista.setStayInScreen(true)
fantasma.setStayInScreen(true)
...
game.onUpdateInterval(1000, function () {
    estrella = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Food)
    estrella.setPosition(randint(0, 120), randint(0, 160))
    estrella.setStayInScreen(true)
})
